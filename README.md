...
- **Komutlar için örnek ayarlamalar, [src/commands/info/ping.js](https://github.com/memte/ExampleBot/blob/v14-es6/src/commands/info/ping.js) dosyasında bulunmaktadır.**  
...
- **Not: Ayarlarınızı [config.js](https://github.com/memte/ExampleBot/blob/v14-es6/src/config.js) dosyasında yapmayı unutmayın.**
